---
title: "Burglary_DistrictTS_GlobalKriging"
date: "August 27, 2015"
...
```{r districtTS-globalKriging,echo=FALSE,warning=FALSE,message=FALSE,cache=TRUE}
...
for (i in 1:length(dateSeq.eval)){ 
  ...
  if (Windowing){
    ...
    # use all training data: work on it later
  ...
  # use only recent *Nvario* samples
